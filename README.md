...
## 📌 Overview
This **XYZ platform** is designed with a **highly available and scalable** architecture, ensuring **fault tolerance and reliability**. The infrastructure is deployed across **two Availability Zones (AZs)**, following a **three-tier architecture** (Web, App, and Data).
